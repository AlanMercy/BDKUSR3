...
<body>
    ...
    <a href="../Tables_add/add_financial_transactions_acc.php" class="btn">Добавить новую операцию</a>
    <table>
        <thead>
            <tr>
            ...
            <?php foreach ($fts as $ft): ?>
                <tr>
                    ...
                    <td class="btn-container">
                        <a href="../Tables_edit/edit_financial_transactions_acc.php?id_ft=<?php echo urlencode($ft['id_ft']); ?>" class="btn">Edit</a>
                        <a href="../Tables_delete/delete_financial_transactions_acc.php?id_ft=<?php echo urlencode($ft['id_ft']); ?>" class="btn" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
