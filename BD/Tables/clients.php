...
<body>
    ...
    <h1>Клиенты</h1>
    <a href="../Tables_add/add_client.php" class="btn">Добавить нового клиента</a>
    <table>
        <thead>
            <tr>
            ...
            <?php foreach ($clients as $client): ?>
                <tr>
                    ...
                    <td class="btn-container">
                        <a href="../Tables_edit/edit_client.php?pass_num_cl=<?php echo $client['pass_num_cl']; ?>" class="btn">Edit</a>
                        <a href="../Tables_delete/delete_client.php?pass_num_cl=<?php echo $client['pass_num_cl']; ?>" class="btn" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
