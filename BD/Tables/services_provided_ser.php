...
<body>
    ...
    <a href="../Tables_add/add_service_provided_ser.php" class="btn">Предоставить услугу</a>
    <table>
        <thead>
            <tr>
            ...
            <?php foreach ($services_provided as $service): ?>
                <tr>
                    ...
                    <td class="btn-container">
                        <a href="../Tables_edit/edit_service_provided_ser.php?id_pr=<?php echo urlencode($service['id_pr']); ?>" class="btn">Edit</a>
                        <a href="../Tables_delete/delete_service_provided_ser.php?id_pr=<?php echo urlencode($service['id_pr']); ?>" class="btn" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
