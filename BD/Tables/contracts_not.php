...
if (isset($_GET['number_c'])) {
    ...
    header("Location: ../Tables/contracts_not.php");
    exit;
}
...
<body>
    <h1>Договоры</h1>
    <a href="../Tables_add/add_contract_not.php" class="btn">Добавить новый договор</a>
    <table>
        <thead>
            <tr>
            ...
            <?php foreach ($contracts as $contract): ?>
                <tr>
                    ...
                    <td class="btn-container">
                        <a href="../Tables_edit/edit_contract_not.php?number_c=<?php echo urlencode($contract['number_c']); ?>" class="btn">Edit</a>
                        <a href="../Tables_delete/delete_contract_not.php?number_c=<?php echo urlencode($contract['number_c']); ?>" class="btn" onclick="return confirm('Are you sure?')">Delete</a>
                        <a href="../Tables/contracts_not.php?number_c=<?php echo urlencode($contract['number_c']); ?>" class="btn">Link Client</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
